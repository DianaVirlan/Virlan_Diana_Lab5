...
namespace Virlan_Diana_Lab5.Controllers
{
    ...
    public class ExpensesController : ControllerBase
    {
        ...
        // GET: api/Expenses
        [HttpGet]
        public async Task<ActionResult<IEnumerable<ExpenseDTO>>> GetExpenseDTO()
        {
        ...
        // GET: api/Expenses/5
        [HttpGet("{id}")]
        public async Task<ActionResult<ExpenseDTO>> GetExpenseDTO(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutExpenseDTO(int id, ExpenseDTO expense)
        {
            if (id != expense.Id)
            {
                return BadRequest();
        ...
        public async Task<ActionResult<ExpenseDTO>> PostExpense(ExpenseDTO expense)
        {
            ...
            return CreatedAtAction(nameof(GetExpenseDTO), new { id = expense.Id }, expense);
        }
